...
import static no.nav.foreldrepenger.log.audit.CefFieldName.ABAC_ACTION;
import static no.nav.foreldrepenger.log.audit.CefFieldName.ABAC_RESOURCE_TYPE;
import static no.nav.foreldrepenger.log.audit.CefFieldName.BERORT_BRUKER_ID;
import static no.nav.foreldrepenger.log.audit.CefFieldName.EVENT_TIME;
import static no.nav.foreldrepenger.log.audit.CefFieldName.REQUEST;
import static no.nav.foreldrepenger.log.audit.CefFieldName.USER_ID;
import static no.nav.foreldrepenger.log.audit.CefFields.forBehandling;
import static no.nav.foreldrepenger.log.audit.CefFields.forSaksnummer;
import static no.nav.foreldrepenger.log.audit.EventClassId.AUDIT_ACCESS;
import static no.nav.foreldrepenger.log.audit.EventClassId.AUDIT_CREATE;
import static no.nav.foreldrepenger.log.audit.EventClassId.AUDIT_UPDATE;
...
import no.nav.foreldrepenger.log.audit.Auditdata;
import no.nav.foreldrepenger.log.audit.AuditdataHeader;
import no.nav.foreldrepenger.log.audit.Auditlogger;
import no.nav.foreldrepenger.log.audit.CefField;
import no.nav.foreldrepenger.log.audit.EventClassId;
